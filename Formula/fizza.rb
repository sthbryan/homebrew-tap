class Fizza < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/sthbryan/fizza/releases/download/v1.0.0/fizza_1.0.0_darwin_arm64.tar.gz"
      sha256 "40f048fb4bc780ccc9344aecd1c7f07ce10ce3b8565369451ab8b7f851035dde"
    end
    on_intel do
      url "https://github.com/sthbryan/fizza/releases/download/v1.0.0/fizza_1.0.0_darwin_amd64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/sthbryan/fizza/releases/download/v1.0.0/fizza_1.0.0_linux_arm64.tar.gz"
      sha256 "6f5ec76a4615e3e419fa3751f831b66c85d7a600a47352f1965ec45a1016e4ba"
    end
    on_intel do
      url "https://github.com/sthbryan/fizza/releases/download/v1.0.0/fizza_1.0.0_linux_amd64.tar.gz"
